...
public class PadawanDtoTest {
    ...
    public PadawanDtoTest(Integer padawanId, String firstName, String lastName, String email, Gender gender, Date birthday, boolean padawanActive) {
