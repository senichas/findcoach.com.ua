...
public class PadawanService {
    ...
    public Enum getCurrentPadawanStatus() {
        return padawanRepository.selectCurrentPadawanStatus((String) SecurityContextHolder.getContext().getAuthentication().getPrincipal());
    }
}